...
public:
  ...
  //  PROMISES: returns true if this-object is greater than or equal to (lexicographically)
  //            to rhs, false otherwise

  bool operator <=(const Mystring& rhs) const; //overloading <= operator
  //  REQUIRES: rhs is a reference to a Mystring as a source
  //  PROMISES: returns true if this-object is less than or equal to (lexicographically)
  //            to rhs, false otherwise
  
  bool operator !=(const Mystring& rhs) const;
  //  REQUIRES: rhs is a reference to a Mystring as a source
  //  PROMISES: returns true if this-object not equal to (lexicographically)
  //            to rhs, false otherwise

  bool operator >(const Mystring& rhs) const;
  //  REQUIRES: rhs is a reference to a Mystring as a source
  //  PROMISES: returns true if this-object is greater than (lexicographically)
  //            to rhs, false otherwise

  bool operator <(const Mystring& rhs) const;
  //  REQUIRES: rhs is a reference to a Mystring as a source
  //  PROMISES: returns true if this-object is less than (lexicographically)
  //            to rhs, false otherwise

  bool operator ==(const Mystring& rhs) const;
  //  REQUIRES: rhs is a reference to a Mystring as a source
  //  PROMISES: returns true if this-object is less equal to (lexicographically)
  //            to rhs, false otherwise
  ...
  friend ostream& operator<<(ostream& os, const Mystring& rhs); //overloading << operator
  //  REQUIRES: rhs is a reference to a Mystring as a source
